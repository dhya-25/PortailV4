...
import { HeaderGroupComponentComponent } from '../header-group-component/header-group-component.component';

@Component({
  selector: 'app-rich-grid-example',
  templateUrl: './rich-grid-example.component.html',
  styleUrls: ['./rich-grid-example.component.css', 'proficiency-renderer.css'],
  encapsulation: ViewEncapsulation.None
})
export class RichGridExampleComponent  {
  ...
  constructor() {
      ...
      this.components = {
          sortableHeaderComponent: HeaderComponentComponent,
          agDateInput: DateComponentComponent,
          headerGroupComponentComponent: HeaderGroupComponentComponent,
          rendererComponent: RendererComponentComponent
      };
      ...
      this.columnDefs = [
          ...
          },
          {
              ...
              children: [
                  {
                      field: 'mobile',
                      cellRenderer: RendererComponentComponent,
                      minWidth: 150,
...
function countryCellRenderer(params: ICellRendererParams) {
  return `<img border='0' width='15' height='10' style='margin-bottom: 2px' src='assets/images/flags/${RefData.COUNTRY_CODES[params.value]}.png'>${params.value}`;
}
